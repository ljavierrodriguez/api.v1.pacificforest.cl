...
@router.get("/", summary='GET Detalle Ide', description='GET Detalle Ide endpoint. Replace this placeholder with a meaningful description.')
def list_detalles(
    ...
    total_items = db.query(DetalleIde).count()
    
    # Obtener elementos de la página actual
    items = db.query(DetalleIde).offset(skip).limit(page_size).all()
