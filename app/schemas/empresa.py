...
class EmpresaCreate(BaseModel):
    ...
    url_logo: str = Field("", description="URL del logo de la empresa", max_length=100)
...
class EmpresaRead(BaseModel):
    ...
    url_logo: Optional[str] = Field(default=None, description="URL del logo de la empresa", max_length=100)
